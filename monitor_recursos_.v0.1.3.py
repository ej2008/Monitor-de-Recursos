...
def calc_batery():
    ...
    if type(batery[1]) == type(int()):
        ...
        batery[1] = (str(horas)+" h " +str(minutos)+ " min")
    else:
        batery[1] = "--"
    if batery[2]:
...
bat_plugged = Label(text= "0", font = "Arial 10", bg = "white")
